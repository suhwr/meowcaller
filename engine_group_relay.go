...
func newGroupRelayAllocateStateWithHBHFEC(
	...
	// Source of truth: https://github.com/suhwr/meowcaller/blob/89ebce510859a415ef19e9b5d74b0006b60ba634/datasheets/group-video-reactions.md#L47-L53
...
func (s *groupRelayAllocateState) Current() []byte {
	// Source of truth: https://github.com/suhwr/meowcaller/blob/a9e4195fb846a730f30ce98c26a7d1c03993fdb2/datasheets/group-media-relay-refresh.md#L60
	s.mu.RLock()
	defer s.mu.RUnlock()
...
func (s *groupRelayAllocateState) SendCurrent(send func([]byte) error) error {
	// Source of truth: https://github.com/suhwr/meowcaller/blob/bcfb7f0c076b131422c22f024dfff080448e70f4/datasheets/group-media-relay-refresh.md#L59-L67
	if send == nil {
...
func buildRelayBindingSuccess(request, integrityKey []byte) ([]byte, bool) {
	// Source of truth: https://github.com/suhwr/meowcaller/blob/a9e4195fb846a730f30ce98c26a7d1c03993fdb2/datasheets/group-media-relay-refresh.md#L72-L92
...
func (s *groupRelayAllocateState) SendBindingSuccess(
	...
	// Source of truth: https://github.com/suhwr/meowcaller/blob/bcfb7f0c076b131422c22f024dfff080448e70f4/datasheets/group-media-relay-refresh.md#L77-L111
	if send == nil {
...
func groupRelayData(update groupCallUpdate, inbound bool) (*relayData, error) {
	// Source of truth: https://github.com/suhwr/meowcaller/blob/a9e4195fb846a730f30ce98c26a7d1c03993fdb2/datasheets/group-media-relay-refresh.md#L64-L92
	if update.Relay == nil {
...
func connectedRemoteParticipantPIDs(update groupCallUpdate, selfID string) []uint32 {
	// Source of truth: https://github.com/suhwr/meowcaller/blob/99134bb900df3ee83a69d9a38112e623817597ae/datasheets/group-video-reactions.md#L40-L50
	var pids []uint32
